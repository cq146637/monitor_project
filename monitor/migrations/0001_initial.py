# Generated by Django 2.0.1 on 2018-01-17 05:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.IntegerField(default=300, verbose_name='报警间隔')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step', models.SmallIntegerField(default=1, verbose_name='第几次报警')),
                ('action_type', models.CharField(choices=[('email', 'Email'), ('sms', 'sms'), ('script', 'script')], default='email', max_length=64, verbose_name='动作类型')),
                ('msg_format', models.CharField(default='Host({hostname},{ip}) service({service_name}) has issue at ({time}),msg:{msg}', max_length=128, verbose_name='消息格式')),
            ],
        ),
        migrations.CreateModel(
            name='Host',
            fields=[
                ...
                ('host_alive_interval', models.IntegerField(default=10, verbose_name='主机存活状态检测间隔')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.IntegerField(choices=[(1, 'Not Classified'), (2, 'Information'), (3, 'Warning'), (4, 'Average'), (5, 'High'), (6, 'Disaster')], verbose_name='报警级别')),
                ('enabled', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specified_item_key', models.CharField(blank=True, max_length=64, null=True, verbose_name='只监控指定的指标')),
                ('operator_type', models.CharField(choices=[('eq', '='), ('lt', '<'), ('gt', '>')], max_length=16, verbose_name='运算符')),
                ('data_calc_func', models.CharField(choices=[('avg', 'Average'), ('max', 'Max'), ('hit', 'Hit'), ('last', 'Last')], max_length=64, verbose_name='数据处理方式')),
                ('operator_calc_args', models.CharField(help_text='若是多个参数,则用逗号分开,第一个值是时间', max_length=64, verbose_name='函数传入参数')),
                ('threshold', models.IntegerField(verbose_name='阈值')),
                ('logic_type', models.CharField(blank=True, choices=[('or', 'OR'), ('and', 'AND')], max_length=32, null=True, verbose_name='多条件关联关系')),
                ('service', models.ForeignKey(on_delete='CASCADE', to='monitor.Service', verbose_name='关联服务')),
                ('service_items', models.ForeignKey(on_delete='CASCADE', to='monitor.ServiceItems', verbose_name='关联服务指标')),
                ('trigger', models.ForeignKey(on_delete='CASCADE', to='monitor.Trigger', verbose_name='所属触发器')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AddField(
            model_name='service',
            name='items',
            field=models.ManyToManyField(blank=True, to='monitor.ServiceItems', verbose_name='指标列表'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='关联触发器', to='monitor.Trigger'),
        ),
    ]
